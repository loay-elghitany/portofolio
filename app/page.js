  ...
  const myProjects = [
    {
      ...
      description:
        "منصة متكاملة بنظام الـ Multi-Tenant مصممة لتحويل العيادات التقليدية إلى عيادات ذكية رقمية بالكامل. يعتمد النظام على تقنيات الذكاء الاصطناعي السحابي لتوفير وقت الأطباء، وتنظيم العمليات المالية، والربط الفوري بين الطبيب، السكرتارية، والمرضى.",
      tags: [
        "React",
        "Node.js",
        "MongoDB",
